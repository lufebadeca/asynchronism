...
fetchMyData(`${API}/products`, function(error1,data1){    //gets all products and stores it into data1
    ...
    fetchMyData(`${API}/products/${data1[0].id}`, function(error2,data2){ //gets the first product's id and stores into data2 
...
//the fetch my data calls are nested since we are using data from the previous calls later on new calls while still available in runtime.
